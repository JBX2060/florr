...
void rr_ladybug_body_draw(struct rr_renderer *);
void rr_ladybug_head_draw(struct rr_renderer *);
...
void rr_portal_draw(struct rr_renderer *);
...
void rr_queen_ant_draw(struct rr_renderer *);
